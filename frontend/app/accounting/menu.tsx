...
const BUSINESS: Section[] = [
  {
    ...
    rows: [
      ...
      { icon: 'list', iconColor: '#2075FF', iconBg: '#DBEAFE', label: 'All Payments-In', route: '/accounting/income' },
  ...
  },
  {
    ...
    rows: [
      ...
      { icon: 'list', iconColor: '#F59E0B', iconBg: '#FEF3C7', label: 'All Payments-Out', route: '/accounting/expenses' },
